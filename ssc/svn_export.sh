...
function svnExport {
    echo "> Retrieving $4"
    svn export --force --username $1 --password $2 --non-interactive --trust-server-cert  $3/$4 $4
}

function svnExportWithVersionNumber {
    echo "> Retrieving '$4' version $5"
    svn export --force --username $1 --password $2 --non-interactive --trust-server-cert $3/$4/$5 $4
}
