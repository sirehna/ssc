/* dqags.f -- translated by f2c (version 20090411).
...
/* Subroutine */ int dqags_(D_fp f, integer *obj, doublereal *a, doublereal *
	b, doublereal *epsabs, doublereal *epsrel, doublereal *result, 
	...
	integer *lenw, integer *last, integer *iwork, doublereal *work)
{
    ...
    extern /* Subroutine */ int dqagse_(D_fp, integer *, doublereal *, 
...
/*         prepare call for dqagse. */
    ...
    dqagse_((D_fp)f, obj, a, b, epsabs, epsrel, limit, result, abserr, neval, 
