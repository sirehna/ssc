...
c            ------------------------------
     ...
     *   ier = 6
c      write(*,*) 'dqagse.f 233: ier = ', ier
      if(ier.eq.6) go to 999
c      write(*,*) 'dqagse.f 235: ier = ', ier
c
...
c
      ...
      oflow = d1mach(2)
      ierro = 0
c      write(*,*) 'dqagse.f 243: ier = ', ier
      call dqk21(f,obj,a,b,result,abserr,defabs,resabs)
c      write(*,*) 'dqagse.f 245: ier = ', ier
c
c           test on accuracy.
c
      dres = dabs(result)
...
c
  ...
  120 continue
c      write(*,*) 'dqagse.f 449: ier = ', ier
      abserr = errsum
  130 if(ier.gt.2) ier = ier-1
c      write(*,*) 'dqagse.f 451: ier = ', ier
  140 neval = 42*last-21
c      write(*,*) 'dqagse.f 453: ier = ', ier
  999 write(*,*) 'dqagse.f 455: ier = ', ier
      return
c      write(*,*) 'dqagse.f 457: ier = ', ier
      end
