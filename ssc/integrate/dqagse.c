/* dqagse.f -- translated by f2c (version 20090411).
...
/* Subroutine */ int dqagse_(D_fp f, real *obj, doublereal *a, doublereal *b, 
	...
	integer *iord, integer *last)
{
    ...
    extern /* Subroutine */ int dqk21_(D_fp, real *, doublereal *, doublereal 
...
/*           ----------------------------------- */
    ...
    oflow = d1mach_(&c__2);
    ierro = 0;
    dqk21_((D_fp)f, obj, a, b, result, abserr, &defabs, &resabs);
...
/*           estimate. */
	...
	b2 = blist[maxerr];
	erlast = errmax;
	dqk21_((D_fp)f, obj, &a1, &b1, &area1, &error1, &resabs, &defab1);
	dqk21_((D_fp)f, obj, &a2, &b2, &area2, &error2, &resabs, &defab2);
