...
namespace ssc
{
    namespace kinematics
    {
         ...
         *  \ingroup kinematics
         *  \section ex1 Example
         *  \snippet kinematics/unit_tests/src/KinematicTreeTest.cpp KinematicsTreeTest example
         *  \section ex2 Expected output
         *  \snippet kinematics/unit_tests/src/KinematicTreeTest.cpp KinematicsTreeTest expected output
         */
        class KinematicTree
        {
            public:
                ...
                /**  \author cec
                  ...
                  *  \snippet kinematics/unit_tests/src/KinematicTreeTest.cpp KinematicsTreeTest add_example
                  */
